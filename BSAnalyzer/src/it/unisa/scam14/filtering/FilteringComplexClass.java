...
public class FilteringComplexClass {

	public static void main(String args[]) {
		//FilteringComplexClass filtering = new FilteringComplexClass();
		//filtering.applyFilter("/Users/fabiopalomba/Desktop/complexClass_0.csv");
	}

	public static void applyFilter(String pPath) {
		Pattern newLine = Pattern.compile("\n");
		Pattern comma = Pattern.compile(";");
		String newContent ="className;isComplexClass;LOC;LCOM;WMC;RFC;CBO;NOM;NOA;DIT;NOC\n";
		try {
			...
			for(int i=1; i<lines.length;i++) {
				...
				if(Integer.parseInt(fields[4]) > 200) {
	...
	public static String applyFilter(String pLine, int pIndex) {
		...
		if(pIndex == 0) {
			return "className;isComplexClass;LOC;LCOM;WMC;RFC;CBO;NOM;NOA;DIT;NOC\n";
		} else {
