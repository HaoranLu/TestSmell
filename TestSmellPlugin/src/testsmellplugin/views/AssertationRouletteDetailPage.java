 ...
 */
public class AssertationRouletteDetailPage extends TitleAreaDialog {
	 ...
	 *            the parent shell
	 */
	public AssertationRouletteDetailPage(TestClassBean testClassBean, Object smellData, Shell shell) {
		super(shell);
		...
		button.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent event) {
				MessageDialog.openInformation(
						parent.getShell(),
						buttonText,
						"Listed assertions don't have explanation. Consider to add the optional argument Error Message to such assertions.");
			}
		});
		if (defaultButton) {
